...
int main(void) {
	...
	while (1) {
		...
		case 1: {
			...
			tree.initialize();
			cout << "Tree succsessfully initialized." << endl;
			break;
		}
		case 2: {
			tree.insert_from_file();
			cout << "Keys succsessfully loaded from file." << endl;
			break;
		}
		case 3: {
			if (!tree.is_empty()) {
		...
		case 6: {
			if (tree.is_empty()) { 
				...
				int key;
				cout << "Unesite kljuc koji treba pronaci:" << endl;
				cin >> key;
				...
				{
					cout << "Key successfuly found at the location: " << ptr << endl;
				}
		...
		case 10: {
			if (tree.is_empty()) 
				...
				tree.delete_tree();
				cout << "Tree succsessfully deleted." << endl;
			}
			break;
		}
		case 0: {
